...
#include "irrigation_controller/irrigation_controller.h" // Задача управления поливом и наполнением бака
...
void app_main() {
    ...
    if (result != pdPASS) {
    ESP_LOGE(MAIN_TAG, "Не удалось запустить irrigation_controller_task");
